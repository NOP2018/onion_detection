...
from WeiboScrapy.spiders.utils import time_fix
import time
        ...
        for tweet_node in tweet_nodes:
            try:
                ...
                if all_content_link:
                    ...
                    p1 = re.compile(r'[【](.*?)[】]',re.S)   #获取标题
                    all_title = re.findall(p1, all_content)
                    tweet_item['content'] = all_title[0]
                    yield tweet_item
